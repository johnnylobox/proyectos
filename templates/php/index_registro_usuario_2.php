...
//	require("datos_conexion.php");
	...
	$verifyMail = new verificacionEmail();

		$verifyMail->emailVerify($correo);


/*	$actividad = new registroUsuario();

		$actividad->verificarPassword($password, $password2);

		$actividad->registrarUser($nombre, $apellido, $correo, $usuario, $password, $password2);*/

	$activity = new registroUsuario();

		$activity->verificarExistenciaCorreo($correo);

	//	$activity->verificarExistenciaUsuario($usuario);

	//	$activity->verificarPassword($password, $password2);

	//	$activity->registroUserEncripted($nombre, $apellido, $correo, $usuario, $password, $password2);
